...
-->
			...
			<?php endif; endif; ?>
              ...
              <p><b>Mass Email Recipiants</b></p>
			   ...
			   <button class="buttonz" type="button" onclick="window.location='<?php echo base_url(); ?>admin_content/download_emails'">Generate Emails CSV</button>
               <div class="clear"></div>
			</form>
<style>
.buttonz{
    background: url(<?php echo base_url();?>/assets/images/button_bg.png) top left repeat-x #DDD;
