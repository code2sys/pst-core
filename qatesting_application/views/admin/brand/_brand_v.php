				...
				<div class="hidden_table">
					<table width="100%" cellpadding="6">
						...
						<tr>
							...
							<td>
								<?php echo form_checkbox('closeout_market_place', 1, '', 'id="closeout_market_place"'); ?>
							</td>
						</tr>
						<tr>
							<td><b>Do not display inventory for Market Places:</b></td>
							<td>
								<?php echo form_checkbox('exclude_market_place', 1, '', 'id="exclude_market_place"'); ?>
							</td>
						</tr>
						<tr>
							<td><b>Title:</b></td>
							<td>
								<input id="title" name="name" value="" class="text large" placeholder="Enter Title" class="text medium" />
							</td>
						</tr>
						<tr>
							<td><b>Meta Tag:</b></td>
				 ...
				 responseData = JSON.parse(encodeResponse);
				  ...
				  else
				  {
			  		  ...
			  		  var href = $("a.image_link").attr("href");
		       		  ...
		       		  if(responseData['exclude_market_place'] == 0)
		       		  	$('#exclude_market_place').prop('checked', false);
		       		  if(responseData['closeout_market_place'] == 1)
		       		  	$('#closeout_market_place').prop('checked', true);
		       		  if(responseData['closeout_market_place'] == 0)
		       		  	$('#closeout_market_place').prop('checked', false);
		       		  	
		       		  $('#title').val(responseData['name']);
