				...
				<div style="width:340px; float:left;">
					<div class="item_photo">
						...
						<?php if (@$product['images']): ?>
								<img itemprop="image" src="<?php echo jsite_url('/productimages/'); ?><?php echo $product['images'][0]['path']; ?>" id="base_image">
							 <?php else: ?>
							...
							<div class="item_photo_bar">
									...
									<div class="gallery_frame">
										<div class="gallery_inner">
												...
												<a href="javascript:void(0);" onclick="changeImage('<?php echo $key; ?>');" ><img src="<?php echo jsite_url('/productimages/'); ?><?php echo $image['path']; ?>" id="small_image_<?php echo $key; ?>"></a>
												</div>
												<?php endforeach; endif;?>
