	...
	<!--<div class="searchHolder search-two">
		...
		<!--<div class="filterBar">
			...
			<div id="toggle">
				<ul>
					<li>
						<div class="heading one">SHOP BY MACHINE</div>
					</li>
					<div class="tlg">
