...
<!-- Finance FORM-->
    <?php echo form_open(secure_site_url('/pages/index/financerequest'), array('id' => 'form_example', 'autocomplete' => 'off')); ?>
        <div class="name_box_full" style="background:rgba(153, 153, 153, 0.28);padding: 30px;">
            ...
            <div class="hidden_table">
                ...
                <table width="100%" cellpadding="5" style="border-bottom: 1px solid #555;">
                    <col width="70%">
                    <col width="30%">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo form_dropdown('driver_licence_state', $states, $_POST['driver_licence_state'], 'id="driver_licence_state"'); ?>
                            <span><b>*</b></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <!-- // End Applicant Contact Information -->
                    ...
                    <tr class="joint-row">
                        ...
                        <td>
                        <?php echo form_dropdown('co_driver_licence_state', $states, $_POST['co_driver_licence_state'], 'id="co_driver_licence_state"'); ?>
                            <span><b>*</b></span>
                        </td>
                    </tr>
                    <tr class="joint-row">
                    ...
                    <tr class="joint-row">
                        ...
                        <td>
                            <select name="co_contact_info[us_citizen]">
                                <option value="">Please Select</option>
                                <option value="yes" <?php echo $_POST['co_contact_info']['us_citizen'] == 'yes'?'selected':'';?>>Yes</option>
                                <option value="no" <?php echo $_POST['co_contact_info']['us_citizen']=='no'?'selected':'';?>>No</option>
                            </select>
                        </td>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="housing_info[home_address]" placeholder="" value="<?php echo $_POST['housing_info']['home_address'];?>" />
                            <span><b>*</b></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input name="housing_info[county]" placeholder="" value="<?php echo $_POST['housing_info']['county'];?>" />
                            <span><b>*</b></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="joint-row">
                        ...
                        <td>
                            <input name="co_housing_info[home_address]" placeholder="" value="<?php echo $_POST['co_housing_info']['home_address'];?>" />
                            <span><b>*</b></span>
                        </td>
                    </tr>
                    <tr class="joint-row">
                        ...
                        <td>
                            <input name="co_housing_info[county]" placeholder="" value="<?php echo $_POST['co_housing_info']['county'];?>" />
                            <span><b>*</b></span>
                        </td>
                    </tr>
                    <tr class="joint-row">
                    ...
                    <tr class="joint-row">
                        ...
                        <td>
                            <input name="co_employer_info[pay_frequency]" placeholder="" value="<?php echo $_POST['co_employer_info']['pay_frequency'];?>" />
                            <span><b>*</b></span>
                        </td>
                    </tr>
                    <tr class="joint-row">
                    ...
                    <tr class="joint-row co_prior_employment_history">
                        ...
                        <td>
                            <input name="co_prior_employer_info[pay_frequency]" placeholder="" value="<?php echo $_POST['co_prior_employer_info']['pay_frequency'];?>" />
                            <span><b>*</b></span>
                        </td>
                    </tr>
                    <tr class="joint-row co_prior_employment_history">
                ...
                <table cellpadding="5" width="100%">
                    ...
                    <tr>
                        <td><label for="name1" >Name</label></td>
                        <td style="width:25%"><input style="width:60%" name="reference[name2]" placeholder="" value="<?php echo $_POST['reference']['name2'];?>" /><span><b>*</b></span></td>
                        <td><label for="phone1" >Phone</label></td>
                        <td style="width:25%"><input style="width:60%" name="reference[phone2]" placeholder="" value="<?php echo $_POST['reference']['phone2'];?>" /><span><b>*</b></span></td>
                        <td><label for="city1" >City</label></td>
                        <td style="width:25%"><input style="width:60%" name="reference[city2]" placeholder="" value="<?php echo $_POST['reference']['city2'];?>" /><span><b>*</b></span></td>
                        <td><label for="state1" >State</label></td>
                        <td style="width:25%"><input style="width:60%" name="reference[state2]" placeholder="" value="<?php echo $_POST['reference']['state2'];?>" /><span><b>*</b></span></td>
                    </tr>
                    <tr>
                        <td><label for="name1" >Name</label></td>
                        <td style="width:25%"><input style="width:60%" name="reference[name3]" placeholder="" value="<?php echo $_POST['reference']['name3'];?>" /><span><b>*</b></span></td>
                        <td><label for="phone1" >Phone</label></td>
                        <td style="width:25%"><input style="width:60%" name="reference[phone3]" placeholder="" value="<?php echo $_POST['reference']['phone3'];?>" /><span><b>*</b></span></td>
                        <td><label for="city1" >City</label></td>
                        <td style="width:25%"><input style="width:60%" name="reference[city3]" placeholder="" value="<?php echo $_POST['reference']['city3'];?>" /><span><b>*</b></span></td>
                        <td><label for="state1" >State</label></td>
                        <td style="width:25%"><input style="width:60%" name="reference[state3]" placeholder="" value="<?php echo $_POST['reference']['state3'];?>" /><span><b>*</b></span></td>
                    </tr>
                    <tr>
                        <td><label for="name1" >Name</label></td>
                ...
                <div style="width: 100%; border-top: 2px solid #555555; margin-top: 10px;">
