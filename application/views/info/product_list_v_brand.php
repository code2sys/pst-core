...
<div class="content_wrap">
    ...
    <div class="main_content fl-wdh">
        <div style="float: right">
            <a href="<?php echo base_url("shopping/search_product"); ?>?brand_bypass=1&brand_id=<?php echo $brand_id; ?>&search=<?php echo urlencode($brand_slug); ?>" class="button">View All <?php echo trim($headTitle); ?> Products</a>
        </div>
