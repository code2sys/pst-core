                ...
                <div class="showroom-grid-widget-rows">
                    ...
                    <?php for ($i = 0; $i < count($grid_widget["tiles"]); $i++) {
                        ...
                        <div class="span3 showroom-tile">
                            <a href="<?php echo site_url('Factory_Showroom/' . $tile["url_fragment"]); ?>" class="showroom-tile-link"><div class="showroom-tile-image" style="background-image: -webkit-radial-gradient(top center, ellipse cover, rgba(255,255,255,0.2) 0%,rgba(0,0,0,0.2) 100%), url('<?php echo (is_null($tile['thumbnail']) || $tile['thumbnail'] == '') ? site_url('/assets/showcase_no_picture_available.png') : $tile['thumbnail']; ?>'); "></div><span class="showroom-tile-title"><?php echo $tile["title"]; ?></span><div class="clear: both"></div></a>
                        </div>
                        <?php
                    } ?>
