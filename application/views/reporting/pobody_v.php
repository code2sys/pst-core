    ...
    if($i > 35) // Too big for one page
    {
      ...
      SetLeftMargin(10);
		...
		if( @$product['question'] ) {
			...
			SetLeftMargin(50);
			SetY($y+5);
			Cell(105,5, strip_tags($product['question']),'LR',1,'L',0); // Description Line Item Variable
			SetLeftMargin(155);
			SetY($y+5);
			Cell(40,5, '','LR',1,'R',0); // Description Line Item Variable
		}
		if( @$product['fitment'] ) {
			SetLeftMargin(10);
			SetFillColor(255, 255, 255);
			...
			Cell(105,5, strip_tags($product['fitment']),'LR',1,'L',0); // Description Line Item Variable
			SetLeftMargin(155);
			if( @$product['question'] ) {
				SetY($y+10);
			} else {
