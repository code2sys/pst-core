		   ...
		   <?php if(validation_errors() || @$errors): ?>
			...
			<div class="tab">
				<ul>
					...
					<li><a href="<?php echo base_url('admin/category_video/'.$id); ?>" class="active"><i class="fa fa-image"></i>&nbsp;Videos*</a></li>
					<div class="clear"></div>
				</ul>
			</div>
			<!-- END TABS -->
			...
			<div class="tab_content" style="width:110%;">
				...
				<?php echo form_open_multipart('admin/category_video/'. $id, array('class' => 'form_standard', 'id' => 'admin_brand_form')); ?> 
					<table width="100%" cellpadding="6">
						...
						<tbody class="tbdy">
					<?php foreach( $category_video as $key => $val ) { ?>
						<tr>
							<td>
