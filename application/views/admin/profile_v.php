...
<!--						</tr>-->
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).ready(function () {
                                ...
                                $("#store_header_marquee_color_dropDownButton").jqxDropDownButton('setContent', getTextElementByColor(new $.jqx.color({ hex: "<?php echo substr($store_header_banner_bgcolor, 1); ?>" })));
