...
<div class="content_wrap">
    <div class="content">
        ...
        <h1><i class="fa fa-upload"></i>&nbsp;File Upload - <?php echo $productupload["original_filename"]; ?> - Processing Rows Rows</h1>
        <br>
        ...
        <div style="padding-top: 5em; padding-bottom: 5em; text-align: center">
            ...
            <p><strong>Processing Rows...</strong><br/>We are now processing your rows.</p>
            <p>Please keep this window open while this upload is processed.</p>
            <p><?php echo number_format($rows_remaining, 0); ?> Rows Remaining...</p>
            <p>If this page does not refresh in a few seconds, <a href="<?php echo base_url('adminproductuploader/process/' . $productupload_id); ?>">click here.</a></p>
...
<script type="application/javascript">
    (function() {
        setTimeout(function() {
            window.location.href = "<?php echo base_url('adminproductuploader/process/' . $productupload_id); ?>/" + Date.now();
        }, 10000);
    })();
</script>
