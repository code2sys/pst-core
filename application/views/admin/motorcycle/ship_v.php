    ...
    <div class="content">
        ...
        <div class="tab">
            <ul>
                ...
                <li><a href="<?php echo base_url('admin/product_shipping/' . @$product['partnumber']); ?>" class="active"><i class="fa fa-truck"></i>&nbsp;Shipping*</a></li>
            ...
            <div class="tab_content">
                <div class="hidden_table">
                    <table width="100%" cellpadding="6">
                        <tr>
                            <td style="width:130px;" valign="top"><b>Need Wire Frame:</b></td>
                        </tr>
                    </table>
                </div>
            </div>
