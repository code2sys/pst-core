...
<script type="text/template" id="PartPersonalizationPartNumberRow">
    ...
    <td ><%= obj.part_number %></td>
    <?php if ($read_only): ?>
        <td ><% if (obj.lightspeedpart_id && obj.lightspeedpart_id > 0) { %>Qty: <%= obj.qty_available %> Cost: <%= obj.cost %><% } else { %>Qty: <input type="text" name="dealer_quantity" value="<%= obj.dealer_quantity %>" size="8" maxlength="16" /><br/>Cost: <input type="text" name="dealer_cost" value="<%= obj.dealer_cost %>" size="8" maxlength="16" /><br/><button type="button" class="updateDealerInventory">Update</button><% } %></td>
