				...
				<div class="hidden_table">
					<table width="100%" cellpadding="6">
						...
						<tr>
							...
							<td>
								<?php echo form_checkbox('exclude_market_place', 1, $product['partnumbers'][0]['exclude_market_place']); ?>
							</td>
						</tr>
						<tr>
							<td><b>Do not display inventory for Market Places:</b></td>
							<td>
								<?php echo form_checkbox('closeout_market_place', 1, $product['partnumbers'][0]['closeout_market_place']); ?>
							</td>
						</tr>
					</table>
