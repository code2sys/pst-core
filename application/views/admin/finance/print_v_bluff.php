            ...
            <div class="hidden_table">
					<table width="100%" cellpadding="5">
                        ...
                        <tr>
							...
							<td>
								<?php echo date("m/d/Y", strtotime($contact_info->dob)); ?>
							</td>
                        </tr>
						<tr>
							<td>
                        ...
                        <tr>
							<td>
								<label for="dl" >Driver's License State</label>
							</td>
							<td>
								<?php echo $application['driver_licence_state'];?>
							</td>
                        </tr>
                        <tr>
							<td>
							...
							<td>
                                <?php echo date("m/d/Y", strtotime($application['driver_licence_expiration'])); ?>
							</td>
						</tr>
						<tr>
							<td>
                        ...
                        <tr>
							<td>
								<label for="gender" >US Citizen</label>
							</td>
							<td>
								<?php echo $contact_info->us_citizen;?>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
                                <?php echo date("m/d/Y", strtotime($co_contact_info->dob)); ?>
							</td>
						</tr>
						<tr>
							<td>
                        ...
                        <tr>
							...
							<td>
								<?php echo $application['co_driver_licence_state'];?>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
                                <?php echo date("m/d/Y", strtotime($application['co_driver_licence_expiration'])); ?>
							</td>
						</tr>
						<tr>
							<td>
                        ...
                        <tr>
							...
							<td>
								<?php echo $co_contact_info->us_citizen;?>
							</td>
						</tr>
                        <?php endif; ?>
						...
						<tr>
							...
							<td>
								<?php echo $housing_info->home_address;?>
							</td>
						</tr>
						<tr>
							<td>
                        ...
                        <?php if ($application["joint"] > 0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $co_housing_info->home_address;?>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <?php echo $co_housing_info->county;?>
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <tr>
							...
							<td>
								<?php echo $co_employer_info->pay_frequency;?>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
                            ...
                            <?php if ($co_employer_info->year < 2): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $co_prior_employer_info->pay_frequency;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
