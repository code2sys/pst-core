		...
		<h1><i class="fa fa-tags"></i>&nbsp;Category</h1>
			...
			<div class="tabular_data">
				<table width="100%" cellpadding="10">
					...
					<?php if(@$cate): $i=0; foreach($cate as $key => $cate): ?>
					<tr>
						<!--<td><?php echo $key; ?></td>-->
			...
			<div class="tab_content">
				<div class="hidden_table">
					<table width="100%" cellpadding="6">
						<tr>
							<td>
								<?php echo form_open_multipart('admin/category_image/'. $id, array('class' => 'form_standard', 'id' => 'admin_category_form')); ?> 
								<?php echo form_hidden('category_id', $id); ?>
								<?php echo form_upload(array('name' => 'image', 'value' => set_value('main'), 'maxlength' => 50, 'class' => '')); ?><br />
								<button type="submit" id="button"><i class="fa fa-upload"></i>&nbsp;Upload Category Image</button>
								<?php if($cate['image']): ?>
									<div style="float:right"><img style="width:100%;" src="<?php echo base_url($media); ?>/<?php echo $cate['image']; ?>"/></div>
