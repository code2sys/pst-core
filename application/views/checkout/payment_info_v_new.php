	...
	<div class="content_wrap">
		...
		<form action="<?php echo $s_baseURL.'checkout/new_payment'; ?>" method="post" id="form_example" class="form_standard">				
...
<form action="" method="post" id="form_example" class="form_standard">
			...
			<div class="cart_wrap_left" style="height:415px">
				<h1 style="margin:0; float:right;width: 100%;text-align: center;">Total: $<span id="total"></span></h1>
				<div class="clear" style="height:50px;"></div>
				<div style="width:100%;display:flex;align-items:center;padding-left: 95px;">
				<button type="submit" class="input_button_purple" style="float:right;width:225px;height:40px;font-size:16px;text-align:center;">Process Your Order</button>
				</div>
			</div>
			<!-- END CREDIT CARD -->
			<div class="clear"></div>
